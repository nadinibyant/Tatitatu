...
export default function DetailPemasukanJual() {
    ...
    const handleEdit = () => {
        if (isCustom) {
            ...
            navigate(`/laporanKeuangan/pemasukan/penjualan/edit/gudang/${data.nomor}`);
        } else {
                            ...
                            <div className="">
                                ...
                                <p className="font-bold text-lg">
                                    {isGudang 
                                        ...
                                        : `${new Date(data.tanggal).toLocaleDateString()}, ${data.waktu}`
                                    }
                                </p>
                            </div>
                            {!isGudang && (
