                            ...
                            <div className={`relative w-40 h-40 border-2 border-dashed border-${themeColor} rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-gray-400 transition-colors`}>
                                ...
                                <div className="text-center">
                                    <div className="flex justify-center">
                                        ...
                                        <path d="M2 29.0833L11.8019 20.0982C12.1323 19.7954 12.5621 19.6241 13.0102 19.6166C13.4583 19.6092 13.8936 19.7662 14.2338 20.0578L25.8333 30M22.1667 25.4167L26.5419 21.0414C26.854 20.7291 27.2683 20.54 27.7086 20.5086C28.149 20.4773 28.5859 20.606 28.939 20.8709L35 25.4167M24 8H35M29.5 2.5V13.5" stroke="#7B0C42" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                                        </svg>
                                    </div>
