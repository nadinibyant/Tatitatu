                    ...
                    <section
                        ...
                        <div
                            ...
                            <div className="w-full md:w-auto">
                                <Button label="Edit Barang" icon={<svg width="17" height="18" viewBox="0 0 17 18" fill="none"
                            ...
                            <div className="w-full md:w-auto">
                                <Button label="Hapus Barang" icon={<svg width="16" height="18" viewBox="0 0 16 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
