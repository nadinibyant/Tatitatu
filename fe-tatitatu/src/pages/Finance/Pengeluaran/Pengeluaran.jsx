    ...
    const [data, setData] = useState([
        {
            Nomor: 'INC1234',
            Tanggal: '12/05/2024',
            'Deskripsi/Barang': ['Pembayaran Listrik Bulan Januari', 'Token Listrik'],
            Kategori: 'Beban Listrik',
            'Cash/Non-Cash': 'Cash',
            Pengeluaran: 1500000
        },
        {
            Nomor: 'INC1234',
            Tanggal: '12/05/2024',
            'Deskripsi/Barang': ['Gaji Karyawan Bulan Januari', 'Bonus Akhir Tahun'],
            Kategori: 'Gaji',
        ...
        },
        {
            Nomor: 'INC1234',
            Tanggal: '12/05/2024',
            'Deskripsi/Barang': ['Service AC', 'Perbaikan Printer', 'Maintenance Komputer'],
        ...
        },
        {
            Nomor: 'INC1234',
            Tanggal: '12/05/2024',
            'Deskripsi/Barang': ['ATK Bulanan', 'Supplies Kantor'],
            Kategori: 'Beban Operasional',
            'Cash/Non-Cash': 'Cash',
            Pengeluaran: 750000
        }
        ...
        <LayoutWithNav>
            <div className="p-5 relative">
                <section className="flex flex-wrap md:flex-nowrap items-center justify-between space-y-2 md:space-y-0">
                    ...
                    <p className="text-primary text-base font-bold">Daftar Pengeluaran</p>
                    </div>
                ...
                <>
                    ...
                    <div className="space-y-4">
                        ...
                        options={[
                            ...
                            { label: "Beban Listrik", value: "Beban Listrik" },
