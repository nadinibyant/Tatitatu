...
export default function Absensi(){
    ...
    const handleSubmit = () => {
        // Validasi form
        if (!formData.foto || !formData.tanggal || !formData.jamMasuk || !formData.jamKeluar) {
    ...
    const [data, setData] = useState([
        {
            nomor: 1,
            Tanggal: '18-05-2024',
            Foto: <img src="/path/to/your/image.jpg" alt="Foto Absensi" className="w-16 h-16 object-cover rounded"/>,
            'Jam Masuk': '13:00',
            'Jam Keluar': '19:00',
            'Total Menit': `${formatNumber(1400)} Menit`
        },
        {
            nomor: 1,
            Tanggal: '18-05-2024',
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4">
                                ...
                                <Input
                                    ...
                                    onChange={(value) => setFormData({...formData, jamMasuk: value})}
                                    width="w-1/2"
                                    required={true}
                                />
                            </div>
                            ...
                            <Input
                                ...
                                onChange={(value) => setFormData({...formData, jamKeluar: value})}
                                required={true}
                            />
